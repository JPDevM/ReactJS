      ...
      <section className="my-2">
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 bg-dark-light border-setting-top d-none">
              <form>
                <div className="form-check my-2 px-0 text-white">
                  <input className="form-check-input custom-control-imput" type="checkbox" value="" id="defaultCheck1" />
              ...
              <a href="setting_order.html">
                <div className="row align-items-center my-2">
                  ...
                  <div className="col-5 text-white-50 text-right">
                    <p className="my-0 text-truncate">Payment Date
            ...
            <div className="col-12 bg-dark-light border-setting-top">
              <a href="setting_mySubscriptions_total.html">
                <div className="row align-items-center my-2">
                  <div className=" col-7 text-white text-truncate">
                    <p className="my-0">See Total as</p>
                  </div>
                  <div className="col-5 text-white-50 text-right">
                    <p className="my-0 text-truncate">Average Expenses
                      <i className="fa fa-angle-right ml-2" aria-hidden="true"></i>
                    </p>
                  </div>
                </div>
            ...
            <div className="col-12 bg-dark-light border-setting-top  border-setting-bottom">
              <a href="/setting_currency.html">
                <div className="row align-items-center my-2">
                  <div className=" col-7 text-white text-truncate">
                    <p className="my-0">Default Currency</p>
                  </div>
                  <div className="col-5 text-white-50 text-right">
                    <p className="my-0 text-truncate">EUR €
                      <i className="fa fa-angle-right ml-2" aria-hidden="true"></i>
                    </p>
                  </div>
                </div>
            ...
            {/* Actualizaciones */}
            <div className="col-12">
              <p className="text-white-50 mb-0 mt-4 text-uppercase"><small>Updates</small></p>
            </div>
            ...
            <div className="col-12 bg-dark-light border-setting-top">
              <a href="/">
                <div className="row align-items-center my-2">
                  ...
                  <div className="col-5 text-white-50 text-right">
                    <p className="my-0 text-truncate">info@info.com<i className="fa fa-angle-right ml-2" aria-hidden="true"></i>
                    </p>
                  </div>
                </div>
              </a>
